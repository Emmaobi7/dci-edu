...
router.post('/:id/submissions', submissionUpload.array('files', 10), asyncHandler(submitAssignment));
...
router.get('/submission-attachments/:attachmentId/file', asyncHandler(downloadSubmissionAttachment));
